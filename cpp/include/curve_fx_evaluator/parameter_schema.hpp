...
inline constexpr std::array<StaticParameterDescriptor, 60> STATIC_PARAMETERS{{
    ...
    {"pool.fee_gamma", "pool_overrides.pool.fee_gamma", "real", "ratio", "binary64_from_wad_1e18", "candidate", ""},
    {"pool.adjustment_step_min", "pool_overrides.pool.adjustment_step_min", "real", "ratio", "binary64_from_wad_1e18", "candidate", ""},
    {"pool.adjustment_step_max", "pool_overrides.pool.adjustment_step_max", "real", "ratio", "binary64_from_wad_1e18", "candidate", ""},
    ...
    {"run.manifest_path", "open_session.manifest_path", "string", "path", "utf8", "session", ""},
    ...
    {"run.disable_slippage_probes", "open_session.disable_slippage_probes", "boolean", "flag", "json_boolean", "observation", "false"},
    {"run.yb_mode", "open_session.yb_mode", "enum", "yb_mode", "utf8", "session", "\"off\"", "[\"off\",\"passive\",\"active_2l\"]"},
    {"run.yb_releverage", "open_session.yb_releverage", "boolean", "legacy_alias", "json_boolean", "session", "false"},
